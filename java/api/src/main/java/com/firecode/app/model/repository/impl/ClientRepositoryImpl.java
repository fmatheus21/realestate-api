...
public class ClientRepositoryImpl implements ClientRepositoryQuery {
    ...
    public Page<ClientEntity> findAllPaginator(RepositoryFilter filter, Pageable pageable) {
        ...
        TypedQuery<ClientEntity> typedQuery = manager.createQuery(criteriaQuery);
    ...
    private Predicate[] createRestrictions(RepositoryFilter filter, CriteriaBuilder builder, Root<ClientEntity> root) {
    ...
    private void addPageRestrictions(TypedQuery<ClientEntity> typedQuery, Pageable pageable) {
